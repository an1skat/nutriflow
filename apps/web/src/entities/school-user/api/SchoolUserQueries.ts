...
export const schoolUserQueryKeys = {
  ...
  school: (schoolId: string) =>
    [...schoolUserQueryKeys.all, schoolId] as const,
  lists: (schoolId: string) =>
    [...schoolUserQueryKeys.school(schoolId), "list"] as const,
...
export function schoolUsersQueryOptions(
  schoolId: string,
  request: PageRequest,
) {
  return queryOptions({
...
export function schoolUserQueryOptions(
  schoolId: string,
  userId: string,
) {
  return queryOptions({
