...
export type WeeklyMenuImportDiagnostic = z.infer<typeof weeklyMenuImportDiagnosticSchema>;
export type WeeklyMenuImportPortion = z.infer<typeof weeklyMenuImportPortionSchema>;
...
export type WeeklyMenuImportPreview = z.infer<typeof weeklyMenuImportPreviewSchema>;
export type WeeklyMenuImportCommit = z.infer<typeof weeklyMenuImportCommitSchema>;
...
export function getImportPreviewSummary(preview: WeeklyMenuImportPreview) {
  return preview.menus.reduce(
    (summary, entry) => {
      ...
      summary.items += entry.menu.days.reduce((count, day) => count + day.items.length, 0);
      return summary;
    },
