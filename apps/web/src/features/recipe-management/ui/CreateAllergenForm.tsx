...
export function CreateAllergenForm({ onCreated }: { onCreated?: () => void }) {
  ...
  return (
    <form onSubmit={onSubmit} className="grid gap-3 sm:grid-cols-[100px_1fr_auto]">
      <div>
        <label htmlFor="allergen-code" className="nf-label">Код</label>
      ...
      <div>
        <label htmlFor="allergen-name" className="nf-label">Назва</label>
      ...
      <div className="sm:col-span-3">
        <label htmlFor="allergen-description" className="nf-label">Опис</label>
