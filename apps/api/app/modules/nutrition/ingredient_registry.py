...
INGREDIENT_NORM_RULES: dict[str, IngredientNormRule] = {
    ...
    "капуста білокачанна": _rule(NormativeGroupCode.VEGETABLES),
    ...
    "помідор": _rule(NormativeGroupCode.VEGETABLES),
    "помідори свіжі": _rule(NormativeGroupCode.VEGETABLES),
    ...
    'соус "сметанний"': _rule(NormativeGroupCode.DAIRY, product_variant="sour_cream"),
