...
def test_admin_role_is_allowed(identities):
    admin_only = require_roles(UserRole.ADMIN)

    result = asyncio.run(admin_only(identities.admin))
...
def test_admin_can_access_any_school(identities):
    result = authorize_school_access(
        identities.admin,
